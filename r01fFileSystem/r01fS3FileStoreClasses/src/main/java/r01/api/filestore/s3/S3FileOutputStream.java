...
public class S3FileOutputStream 
    ...
    private final AWSS3BucketID _bucket;
    ...
    public S3FileOutputStream(final AWSS3ClientAPI client,final AWSS3BucketID bucket,final AWSS3ObjectKey s3Key) throws IOException {
    	this._client = client;
        this._bucket = bucket;
        this._s3Key = s3Key;
