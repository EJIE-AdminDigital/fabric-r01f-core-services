...
/////////////////////////////////////////////////////////////////////////////////////////	
	private static Properties _propertiesFrom(final SchedulerID schId,
        ...
        outProps.setProperty("org.quartz.scheduler.instanceName",
        					 props.propertyAt(Strings.customized("{}org.quartz.scheduler.instanceName",
        							 							 rootXPath))
        						   .asString(schId.asString()));
		outProps.setProperty("org.quartz.scheduler.instanceId",
							 props.propertyAt(Strings.customized("{}org.quartz.scheduler.instanceId",
									 							 rootXPath))
							 	.asString("AUTO"));
		...
		outProps.setProperty("org.quartz.scheduler.skipUpdateCheck",
							 Boolean.toString(props.propertyAt(Strings.customized("{}org.quartz.scheduler.skipUpdateCheck",
									 											  rootXPath))
								   .asBoolean(true)));
		...
		outProps.setProperty("org.quartz.scheduler.dbFailureRetryInterval",
							 Long.toString(props.propertyAt(Strings.customized("{}org.quartz.scheduler.dbFailureRetryInterval",
									 										   rootXPath))
												 .asLong(10000)));
		...
		outProps.setProperty("org.quartz.scheduler.batchTriggerAcquisitionMaxCount",
							 Integer.toString(props.propertyAt(Strings.customized("{}org.quartz.scheduler.batchTriggerAcquisitionMaxCount",
									 											  rootXPath))
											  		.asInteger(1)));
		...
		outProps.setProperty("org.quartz.threadPool.class",
							 props.propertyAt(Strings.customized("{}org.quartz.threadPool.class",
									 							 rootXPath))
		...
		outProps.setProperty("org.quartz.scheduler.makeSchedulerThreadDaemon",
							 Boolean.toString(props.propertyAt(Strings.customized("{}org.quartz.scheduler.makeSchedulerThreadDaemon",
									 											  rootXPath))
									 				.asBoolean(false)));
		
		// true if the thread pool's thread are daemon threads
		outProps.setProperty("org.quartz.threadPool.makeThreadsDaemons",
							 Boolean.toString(props.propertyAt(Strings.customized("{}quartz/org.quartz.threadPool.makeThreadsDaemons",
									 											  rootXPath))
								  		  			.asBoolean(false)));
		...
		outProps.setProperty("org.quartz.jobStore.misfireThreshold",
							 Long.toString(props.propertyAt(Strings.customized("{}org.quartz.jobStore.misfireThreshold",
									 										   rootXPath))
									  			 .asLong(60)));
		// Job store 
		// How to store the scheduler data
		// Default to RAM storage
		String jobStoreTypeName = props.propertyAt(Strings.customized("{}org.quartz.jobStore.class",
															   		  rootXPath))
		...
		if (jobStoreTypeName.equals(JobStoreTX.class.getName())) {
			outProps.setProperty("org.quartz.jobStore.driverDelegateClass",
								 props.propertyAt(Strings.customized("{}org.quartz.jobStore.driverDelegateClass",
										 							 rootXPath))
										  			  	 .asString("org.quartz.impl.jdbcjobstore.StdJDBCDelegate"));
			outProps.setProperty("org.quartz.jobStore.tablePrefix",
								 props.propertyAt(Strings.customized("{}org.quartz.jobStore.tablePrefix",
										 							 rootXPath))
										  			 	 .asString(""));
			outProps.setProperty("org.quartz.jobStore.driverDelegateClass",
								 props.propertyAt(Strings.customized("{}org.quartz.jobStore.driverDelegateClass",
			...
			outProps.setProperty("org.quartz.jobStore.isClustered",
							 Boolean.toString(props.propertyAt(Strings.customized("{}org.quartz.jobStore.isClustered",
									 											  rootXPath))
								  		  		   .asBoolean(false)));
			...
			outProps.setProperty("org.quartz.jobStore.clusterCheckinInterval",
							 	 Long.toString(props.propertyAt(Strings.customized("{}org.quartz.jobStore.clusterCheckinInterval",
							 			 										   rootXPath))
									  			 	.asLong(15000)));	
			//Datasource conection (driver+user+pass+url or jndi) 
			String dataSource = props.propertyAt(Strings.customized("{}org.quartz.jobStore.dataSource",
																	rootXPath))
														.asString("myDS");
			if (props.propertyAt(Strings.customized("{}org.quartz.jobStore.dataSource",
										 			rootXPath))
					 .exist()) {
				outProps.setProperty("org.quartz.jobStore.dataSource",
									 props.propertyAt(Strings.customized("{}org.quartz.jobStore.dataSource",
											 							 rootXPath))
											  			 	 .asString());
			}
			
			if (props.propertyAt(Strings.customized("{}org.quartz.dataSource.{}.driver",
													rootXPath,dataSource))
					 .exist()) {
				outProps.setProperty(Strings.customized("org.quartz.dataSource.{}.driver",
														dataSource),
									 props.propertyAt(Strings.customized("{}org.quartz.dataSource.{}.driver",
											 							 rootXPath,dataSource))
									 	  .asString());
			}
			...
			if (props.propertyAt(Strings.customized("{}org.quartz.dataSource.{}.URL",
													rootXPath,dataSource))
					 .exist()) {
				outProps.setProperty(Strings.customized("org.quartz.dataSource.{}.URL", 
														dataSource),
			...
			if (props.propertyAt(Strings.customized("{}org.quartz.dataSource.{}.user",
													rootXPath,dataSource))
					 .exist()) {
				outProps.setProperty(Strings.customized("org.quartz.dataSource.{}.user",
														dataSource),
			...
			if (props.propertyAt(Strings.customized("{}org.quartz.dataSource.{}.password",
													rootXPath,dataSource))
					 .exist()) {
				outProps.setProperty(Strings.customized("org.quartz.dataSource.{}.password",
														dataSource),
			...
			if (props.propertyAt(Strings.customized("{}org.quartz.dataSource.{}.jndiURL",
													rootXPath,dataSource))
					 .exist()) {
				outProps.setProperty(Strings.customized("org.quartz.dataSource.{}.jndiURL",
														dataSource),
		...
		else if (jobStoreTypeName.equals(TerracottaJobStore.class.getName())) {
			outProps.setProperty("org.quartz.jobStore.tcConfigUrl",
								 props.propertyAt(Strings.customized("{}org.quartz.jobStore.tcConfigUrl",
										 							 rootXPath))
