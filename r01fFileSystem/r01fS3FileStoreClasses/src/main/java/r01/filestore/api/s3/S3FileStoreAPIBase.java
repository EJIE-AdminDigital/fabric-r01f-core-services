...
import r01.model.oids.KeyPath;
import r01.model.oids.S3File;
import r01.model.oids.S3Folder;
...
//  
/////////////////////////////////////////////////////////////////////////////////////////
	protected static KeyPath r01fPathToS3Path(final r01f.types.Path path) {
		return KeyPath.from(path.asAbsoluteString());
	}
	protected static S3File s3FileFromKeyPath(final KeyPath kPath, final AWSS3BucketConfig bucketConf) {
		_checkPathName(kPath);
		return new S3File(new AWSS3Bucket(bucketConf.getDefaultBucket()), 
	...
	protected static S3Folder s3FolderFromPath(final Path path,
		...
		_checkPathName(path);
		return new S3Folder(new AWSS3Bucket(bucketConf.getDefaultBucket()), 
