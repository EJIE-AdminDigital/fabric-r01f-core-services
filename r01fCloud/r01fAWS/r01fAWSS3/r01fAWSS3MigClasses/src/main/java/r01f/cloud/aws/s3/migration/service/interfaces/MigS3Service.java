...
public interface MigS3Service {
     ...
     */
    public R01TDBEntityForMigS3 save(final R01TDBEntityForMigS3 entity);
    /**
     * Finds a {@link R01TDBEntityForMigS3} entity by its unique identifier (OID).
     *
     * @param migrationOid The OID of the entity to find. Must not be {@code null} or empty.
     ...
     */
    public Optional<R01TDBEntityForMigS3> findByMigrationOid(final String migrationOid);
    /**
     ...
     * @throws IllegalArgumentException if the provided {@code oid} is {@code null} or empty.
     */
    public Optional<R01TDBEntityForMigS3> findByRemotePath(final String remotePath);
}