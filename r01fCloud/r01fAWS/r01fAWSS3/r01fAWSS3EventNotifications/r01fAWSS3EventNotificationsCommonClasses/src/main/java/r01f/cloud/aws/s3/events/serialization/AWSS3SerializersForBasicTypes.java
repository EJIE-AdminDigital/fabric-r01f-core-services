...
/**
 * {@link AWSS3Serializer} for basic types as Long, Integer, Boolean, etc
 *
 */
public class AWSS3SerializersForBasicTypes {
/////////////////////////////////////////////////////////////////////////////////////////
//	Boolean
/////////////////////////////////////////////////////////////////////////////////////////
	public static  class BooleanSerializerBase
	      implements AWSS3Serializer<Boolean> {
		@Override
...
/////////////////////////////////////////////////////////////////////////////////////////
	public static abstract class DateSerializerBase
	  		          implements AWSS3Serializer<Date> {
		@Override
...
/////////////////////////////////////////////////////////////////////////////////////////
	public static abstract class LongSerializerBase
	  		  implements AWSS3Serializer<Long> {
		@Override
...
/////////////////////////////////////////////////////////////////////////////////////////
	public static  class RangeSerializer
					  implements AWSS3Serializer<Range<?>> {
		@Override
