...
public class TransformerFromS3ObjectToModelObjectDefault <K extends IsS3Key,V extends S3PersistableKeyValueObject<K>>
     extends S3FileStoreTransformerBase<K,V>
  implements IsTransformerFromS3ObjectToModelObject<K,V> {
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// CONSTRUCTOR
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	public TransformerFromS3ObjectToModelObjectDefault(final Class<V> modelObjectType,final KVModuleConfig  kvCfg,
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public V transform(final AWSS3ObjectGetResult s3Object) {
